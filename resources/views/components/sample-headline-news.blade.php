...
<link href="{{ asset('css/bootstrap.css')}}" rel="stylesheet">
  ...
  <body>
        ...
        <div class="container">
            @if($headline)
                <div class="card my-2">
                    <h5 class="card-header">{{ $headline->title }}</h5>
                    <div class="card-body">
                        <h5 class="card-title">{{ $headline->name }}</h5>
                        <p class="card-text">{{ $headline->content }}</p>
                        <p class="card-text">{{ $headline->description }}</p>
                        <p class="card-text">{{ $headline->publishedAt }}</p>
